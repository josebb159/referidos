                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="assets/images/Logo-club-sky-afiliados.svg" alt="" height="28"> <span class="logo-txt">Afiliado ClubSky</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Bienvenido !</h5>
                                            <p class="text-muted mt-2">Inicia sesión para continuar a Afiliado ClubSky.</p>
                                        </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Afiliado ClubSky . Crafted with <i class="mdi mdi-heart text-danger"></i> by SP production</p>
                                    </div>
                                </div>
                            </div>
                        </div>
