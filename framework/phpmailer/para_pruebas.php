...
$mail->Username   = 'support@clubsky.online';              // Nombre de usuario SMTP
    $mail->Password   = 'Siul2023@K';                     // Contraseña SMTP
$mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Habilitar cifrado TLS o STARTTLS
$mail->Port       = 587;                
    

    //Recipients
    $mail->setFrom('support@clubsky.online', 'ClubSky');
...
$mail->addAddress($correo);
    ...
    $mail->Subject = 'ClubSky';
    $mail->Body    = 'Recuperar contraseña';
...
<table id="u_content_text_2" style="font-family:Rubik,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="line-height: 170%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;">Esperamos que este mensaje te encuentre bien. Hemos recibido una solicitud para recuperar la contraseña asociada a tu cuenta. A continuacion se mostrara tu contraseña, no lo compartas con nadie.</p>
  </div>
...
<table style="font-family:Rubik,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;">Contraseña:</p>
  </div>
...
//        $mail->addAttachment('../apis/interrapidisimo/v1_5/'.$guia.'.pdf');   
 ...
 //emails("sofiavayoleth5@gmail.com", "200090", "siul negrito")
?>