						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-6">
									...
									<input type="text" class="form-control" id="id_categoria" placeholder="categoria" value="" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-6">
									<label for="validationCustom01" class="form-label">categoria</label>
									<input type="text" class="form-control" id="id_categoriaagg" placeholder="categoria" value="" required>
								</div>
							</div>
						</div>
					</div>
